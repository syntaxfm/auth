/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 08e0510679f4c4fc76d8ac2e7c06ef83)
...
interface __BaseEnv_Env {
	...
	GITHUB_CLIENT_ID?: "Ov23liaN1JKT8pC8OZg6";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.svelte-kit/cloudflare/_worker");
	}
	interface OauthRegistrationEnv {
		DB: D1Database;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "AUTH_COOKIE_DOMAIN" | "GITHUB_CLIENT_ID">> {}
}
